  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-6 sm:py-12 bg-[#FBF2C0] px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md">
        ...
        <h2 className={`${pangolin.className} mt-4 sm:mt-6 text-center text-4xl sm:text-5xl font-bold tracking-tight text-[#48392A]`}>
          FocusUp <span className="text-[#F96F5D]">!</span>
        </h2>
        <p className={`${pangolin.className} mt-2 text-center text-xs sm:text-sm text-[#48392A]`}>
          Let&apos;s get started
        </p>
      </div>
